...
const (
	...
	GolangParserT__65          = 66
	GolangParserT__66          = 67
	GolangParserT__67          = 68
	GolangParserIDENTIFIER     = 69
	GolangParserKEYWORD        = 70
	GolangParserBINARY_OP      = 71
	GolangParserINT_LIT        = 72
	GolangParserFLOAT_LIT      = 73
	GolangParserIMAGINARY_LIT  = 74
	GolangParserRUNE_LIT       = 75
	GolangParserLITTLE_U_VALUE = 76
	GolangParserBIG_U_VALUE    = 77
	GolangParserSTRING_LIT     = 78
	GolangParserWS             = 79
	GolangParserCOMMENT        = 80
	GolangParserTERMINATOR     = 81
	GolangParserLINE_COMMENT   = 82
)
...
func (p *GolangParser) SourceFile() (localctx ISourceFileContext) {
	...
	for (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__6)|(1<<GolangParserT__12)|(1<<GolangParserT__15))) != 0) || _la == GolangParserIDENTIFIER {
		{
			p.SetState(218)
			p.TopLevelDecl()
		}
...
func (p *GolangParser) ConstDecl() (localctx IConstDeclContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case GolangParserT__10, GolangParserIDENTIFIER:
		{
			p.SetState(263)
			p.ConstSpec()
		}
	...
	case GolangParserT__7:
		...
		for _la == GolangParserT__10 || _la == GolangParserIDENTIFIER {
			{
				p.SetState(265)
				p.ConstSpec()
			}
...
func (p *GolangParser) ConstSpec() (localctx IConstSpecContext) {
	...
	if p.GetInterpreter().AdaptivePredict(p.GetTokenStream(), 10, p.GetParserRuleContext()) == 1 {
		...
		if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__7)|(1<<GolangParserT__16)|(1<<GolangParserT__23))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserIDENTIFIER-49)))) != 0) {
			{
				p.SetState(277)
				p.Type_()
			}
...
func (p *GolangParser) IdentifierList() (localctx IIdentifierListContext) {
	...
	if !(_la == GolangParserT__10 || _la == GolangParserIDENTIFIER) {
		p.GetErrorHandler().RecoverInline(p)
	} else {
		p.GetErrorHandler().ReportMatch(p)
		p.Consume()
...
func (p *GolangParser) Function() (localctx IFunctionContext) {
	...
	case GolangParserT__6, GolangParserT__7, GolangParserT__10, GolangParserT__12, GolangParserT__15, GolangParserT__16, GolangParserT__19, GolangParserT__20, GolangParserT__22, GolangParserT__23, GolangParserT__28, GolangParserT__31, GolangParserT__32, GolangParserT__33, GolangParserT__34, GolangParserT__35, GolangParserT__36, GolangParserT__37, GolangParserT__38, GolangParserT__40, GolangParserT__42, GolangParserT__45, GolangParserT__47, GolangParserT__48, GolangParserT__50, GolangParserT__51, GolangParserT__52, GolangParserT__53, GolangParserT__55, GolangParserT__56, GolangParserT__57, GolangParserT__58, GolangParserT__67, GolangParserIDENTIFIER, GolangParserINT_LIT, GolangParserFLOAT_LIT, GolangParserIMAGINARY_LIT, GolangParserRUNE_LIT, GolangParserSTRING_LIT:
		{
			p.SetState(322)
			p.StatementNoBlock()
		}
...
func (p *GolangParser) VarSpec() (localctx IVarSpecContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case GolangParserT__7, GolangParserT__16, GolangParserT__23, GolangParserT__48, GolangParserT__50, GolangParserT__51, GolangParserT__52, GolangParserT__53, GolangParserT__58, GolangParserIDENTIFIER:
		{
			p.SetState(349)
			p.Type_()
		}
...
func (p *GolangParser) IncDecStmt() (localctx IIncDecStmtContext) {
	...
	if !(_la == GolangParserT__17 || _la == GolangParserT__18) {
		p.GetErrorHandler().RecoverInline(p)
	} else {
		p.GetErrorHandler().ReportMatch(p)
		p.Consume()
...
func (p *GolangParser) Assign_op() (localctx IAssign_opContext) {
	...
	if ((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__21)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__24)|(1<<GolangParserT__25)|(1<<GolangParserT__26)|(1<<GolangParserT__27)|(1<<GolangParserT__28)|(1<<GolangParserT__29))) != 0 {
		p.SetState(424)
		_la = p.GetTokenStream().LA(1)
...
func (p *GolangParser) ExprSwitchStmt() (localctx IExprSwitchStmtContext) {
	...
	if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__7)|(1<<GolangParserT__10)|(1<<GolangParserT__16)|(1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__28))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__55-49))|(1<<(GolangParserT__56-49))|(1<<(GolangParserT__57-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserT__67-49))|(1<<(GolangParserIDENTIFIER-49))|(1<<(GolangParserINT_LIT-49))|(1<<(GolangParserFLOAT_LIT-49))|(1<<(GolangParserIMAGINARY_LIT-49))|(1<<(GolangParserRUNE_LIT-49))|(1<<(GolangParserSTRING_LIT-49)))) != 0) {
		{
			p.SetState(484)
			p.expression(0)
		}
	...
	for (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__7)|(1<<GolangParserT__10)|(1<<GolangParserT__16)|(1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__28))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__55-49))|(1<<(GolangParserT__56-49))|(1<<(GolangParserT__57-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserT__67-49))|(1<<(GolangParserIDENTIFIER-49))|(1<<(GolangParserINT_LIT-49))|(1<<(GolangParserFLOAT_LIT-49))|(1<<(GolangParserIMAGINARY_LIT-49))|(1<<(GolangParserRUNE_LIT-49))|(1<<(GolangParserSTRING_LIT-49)))) != 0) {
		{
			p.SetState(488)
			p.ExprCaseClause()
		}
...
func (p *GolangParser) TypeSwitchStmt() (localctx ITypeSwitchStmtContext) {
	...
	for (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__7)|(1<<GolangParserT__10)|(1<<GolangParserT__16)|(1<<GolangParserT__23))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserIDENTIFIER-49)))) != 0) {
		{
			p.SetState(512)
			p.TypeCaseClause()
		}
...
func (p *GolangParser) SelectStmt() (localctx ISelectStmtContext) {
	...
	for _la == GolangParserT__43 || _la == GolangParserT__44 {
		{
			p.SetState(548)
			p.CommClause()
		}
...
func (p *GolangParser) ForClause() (localctx IForClauseContext) {
	...
	if (((_la-8)&-(0x1f+1)) == 0 && ((1<<uint((_la-8)))&((1<<(GolangParserT__7-8))|(1<<(GolangParserT__10-8))|(1<<(GolangParserT__16-8))|(1<<(GolangParserT__19-8))|(1<<(GolangParserT__20-8))|(1<<(GolangParserT__22-8))|(1<<(GolangParserT__23-8))|(1<<(GolangParserT__28-8))|(1<<(GolangParserT__31-8)))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__55-49))|(1<<(GolangParserT__56-49))|(1<<(GolangParserT__57-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserT__67-49))|(1<<(GolangParserIDENTIFIER-49))|(1<<(GolangParserINT_LIT-49))|(1<<(GolangParserFLOAT_LIT-49))|(1<<(GolangParserIMAGINARY_LIT-49))|(1<<(GolangParserRUNE_LIT-49))|(1<<(GolangParserSTRING_LIT-49)))) != 0) {
		{
			p.SetState(594)
			p.SimpleStmt()
		}
...
func (p *GolangParser) Type_() (localctx IType_Context) {
	...
	case GolangParserT__16, GolangParserT__23, GolangParserT__48, GolangParserT__50, GolangParserT__51, GolangParserT__52, GolangParserT__53, GolangParserT__58:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(610)
			p.TypeLit()
...
func (p *GolangParser) Parameters() (localctx IParametersContext) {
	...
	if p.GetInterpreter().AdaptivePredict(p.GetTokenStream(), 63, p.GetParserRuleContext()) == 1 {
		...
		if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__7)|(1<<GolangParserT__10)|(1<<GolangParserT__16)|(1<<GolangParserT__23))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__54-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserIDENTIFIER-49)))) != 0) {
			{
				p.SetState(704)
				p.ParameterList()
			}
...
func (p *GolangParser) Literal() (localctx ILiteralContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case GolangParserT__55, GolangParserT__56, GolangParserT__57, GolangParserINT_LIT, GolangParserFLOAT_LIT, GolangParserIMAGINARY_LIT, GolangParserRUNE_LIT, GolangParserSTRING_LIT:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(738)
			p.BasicLit()
	...
	case GolangParserT__48, GolangParserT__51, GolangParserT__58, GolangParserIDENTIFIER:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(739)
			p.CompositeLit()
...
func (p *GolangParser) BasicLit() (localctx IBasicLitContext) {
	...
	case GolangParserT__55, GolangParserT__56:
		p.EnterOuterAlt(localctx, 6)
		p.SetState(748)
		_la = p.GetTokenStream().LA(1)

		if !(_la == GolangParserT__55 || _la == GolangParserT__56) {
			p.GetErrorHandler().RecoverInline(p)
		} else {
			p.GetErrorHandler().ReportMatch(p)
			p.Consume()
	...
	case GolangParserT__57:
		p.EnterOuterAlt(localctx, 7)
		{
			p.SetState(749)
			p.Match(GolangParserT__57)
		}
...
func (p *GolangParser) LiteralValue() (localctx ILiteralValueContext) {
	...
	if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__2)|(1<<GolangParserT__7)|(1<<GolangParserT__10)|(1<<GolangParserT__16)|(1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__28))) != 0) || (((_la-49)&-(0x1f+1)) == 0 && ((1<<uint((_la-49)))&((1<<(GolangParserT__48-49))|(1<<(GolangParserT__50-49))|(1<<(GolangParserT__51-49))|(1<<(GolangParserT__52-49))|(1<<(GolangParserT__53-49))|(1<<(GolangParserT__55-49))|(1<<(GolangParserT__56-49))|(1<<(GolangParserT__57-49))|(1<<(GolangParserT__58-49))|(1<<(GolangParserT__67-49))|(1<<(GolangParserIDENTIFIER-49))|(1<<(GolangParserINT_LIT-49))|(1<<(GolangParserFLOAT_LIT-49))|(1<<(GolangParserIMAGINARY_LIT-49))|(1<<(GolangParserRUNE_LIT-49))|(1<<(GolangParserSTRING_LIT-49)))) != 0) {
		{
			p.SetState(776)
			p.ElementList()
		}
...
func (p *GolangParser) Element() (localctx IElementContext) {
	...
	switch p.GetTokenStream().LA(1) {
	case GolangParserT__7, GolangParserT__10, GolangParserT__16, GolangParserT__19, GolangParserT__20, GolangParserT__22, GolangParserT__23, GolangParserT__28, GolangParserT__48, GolangParserT__50, GolangParserT__51, GolangParserT__52, GolangParserT__53, GolangParserT__55, GolangParserT__56, GolangParserT__57, GolangParserT__58, GolangParserT__67, GolangParserIDENTIFIER, GolangParserINT_LIT, GolangParserFLOAT_LIT, GolangParserIMAGINARY_LIT, GolangParserRUNE_LIT, GolangParserSTRING_LIT:
		p.EnterOuterAlt(localctx, 1)
		{
			p.SetState(806)
			p.expression(0)
...
func (p *GolangParser) Binary_op() (localctx IBinary_opContext) {
	...
	if !((((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__21)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__24)|(1<<GolangParserT__25)|(1<<GolangParserT__26)|(1<<GolangParserT__27)|(1<<GolangParserT__28)|(1<<GolangParserT__29))) != 0) || (((_la-60)&-(0x1f+1)) == 0 && ((1<<uint((_la-60)))&((1<<(GolangParserT__59-60))|(1<<(GolangParserT__60-60))|(1<<(GolangParserT__61-60))|(1<<(GolangParserT__62-60))|(1<<(GolangParserT__63-60))|(1<<(GolangParserT__64-60))|(1<<(GolangParserT__65-60))|(1<<(GolangParserT__66-60)))) != 0)) {
		p.GetErrorHandler().RecoverInline(p)
	} else {
		p.GetErrorHandler().ReportMatch(p)
		p.Consume()
...
func (p *GolangParser) Unary_op() (localctx IUnary_opContext) {
	...
	if !((((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<GolangParserT__16)|(1<<GolangParserT__19)|(1<<GolangParserT__20)|(1<<GolangParserT__22)|(1<<GolangParserT__23)|(1<<GolangParserT__28))) != 0) || _la == GolangParserT__67) {
		p.GetErrorHandler().RecoverInline(p)
	} else {
		p.GetErrorHandler().ReportMatch(p)
		p.Consume()
