...
var parserATN = []uint16{
	...
	3, 86, 5, 86, 828, 10, 86, 3, 87, 5, 87, 831, 10, 87, 3, 87, 3, 87, 3,
	...
	827, 3, 2, 2, 2, 172, 830, 3, 2, 2, 2, 174, 841, 3, 2, 2, 2, 176, 854,
	...
	2, 2, 2, 813, 810, 3, 2, 2, 2, 814, 167, 3, 2, 2, 2, 815, 816, 5, 170,
	86, 2, 816, 817, 5, 172, 87, 2, 817, 169, 3, 2, 2, 2, 818, 828, 5, 182,
	92, 2, 819, 828, 5, 120, 61, 2, 820, 821, 7, 50, 2, 2, 821, 822, 7, 58,
	2, 2, 822, 823, 7, 51, 2, 2, 823, 828, 5, 124, 63, 2, 824, 828, 5, 130,
	66, 2, 825, 828, 5, 132, 67, 2, 826, 828, 5, 116, 59, 2, 827, 818, 3, 2,
	2, 2, 827, 819, 3, 2, 2, 2, 827, 820, 3, 2, 2, 2, 827, 824, 3, 2, 2, 2,
	827, 825, 3, 2, 2, 2, 827, 826, 3, 2, 2, 2, 828, 171, 3, 2, 2, 2, 829,
	831, 5, 144, 73, 2, 830, 829, 3, 2, 2, 2, 830, 831, 3, 2, 2, 2, 831, 832,
	...
	813, 827, 830, 835, 837, 843, 848, 854, 861, 865, 869, 872, 880, 884, 891,
...
func (s *LiteralValueContext) TemplateSpec() ITemplateSpecContext {
	var t = s.GetTypedRuleContext(reflect.TypeOf((*ITemplateSpecContext)(nil)).Elem(), 0)
...
func (p *OgParser) LiteralValue() (localctx ILiteralValueContext) {
	...
	if (((_la)&-(0x1f+1)) == 0 && ((1<<uint(_la))&((1<<OgParserT__1)|(1<<OgParserT__3)|(1<<OgParserT__5)|(1<<OgParserT__15)|(1<<OgParserT__17)|(1<<OgParserT__20)|(1<<OgParserT__21)|(1<<OgParserT__23)|(1<<OgParserT__28))) != 0) || (((_la-48)&-(0x1f+1)) == 0 && ((1<<uint((_la-48)))&((1<<(OgParserT__47-48))|(1<<(OgParserT__49-48))|(1<<(OgParserT__50-48))|(1<<(OgParserT__51-48))|(1<<(OgParserT__52-48))|(1<<(OgParserT__53-48))|(1<<(OgParserT__56-48))|(1<<(OgParserT__57-48))|(1<<(OgParserT__58-48))|(1<<(OgParserT__59-48))|(1<<(OgParserT__60-48))|(1<<(OgParserT__61-48))|(1<<(OgParserIDENTIFIER-48))|(1<<(OgParserINT_LIT-48))|(1<<(OgParserFLOAT_LIT-48))|(1<<(OgParserIMAGINARY_LIT-48))|(1<<(OgParserRUNE_LIT-48))|(1<<(OgParserSTRING_LIT-48)))) != 0) {
		{
			p.SetState(831)
			p.ElementList()
		}
...
func (p *OgParser) Element() (localctx IElementContext) {
	...
	case OgParserT__5, OgParserT__53:
		p.EnterOuterAlt(localctx, 2)
		{
			p.SetState(862)
			p.LiteralValue()
